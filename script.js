...
const secondOverflow = document.getElementById('secondOverflow');

if (firstOverflow.style.display != 'none') {
  firstOverflow.style.display = 'none';
  secondOverflow.style.display = 'block';
}

const funnelsViewer = document.getElementById('funnelsViewer');
if (funnelsViewer.classList.contains('ghost')) {
  secondOverflow.style.display = 'none';
}

document.getElementById('viewerSection').style.display = 'none';
funnelsViewer.classList.remove('ghost');
